const id = {
  ...
  'volcano': 'Gunung Api',
  'comming_soon': 'Pronto',
  'coming_soon_2020': 'Pronto!',
  'reports_stats': 'Recibido {reportsplaceholder} reportes  activos en {provinceplaceholder}',
  'prep_menu': {
    'btn_names': {
  ...
  'report_info': {
    ...
    'share_msg': 'Consulte%20inundacion%20reportes%20en%20mapeatudesastre%2org',
    'water_depth': 'Altura de la inundación:',
    ...
    'flagReport_email': 'betty.chemier@undp.org',
  ...
  'flood_info': {
    'title': 'Área afectada por inundación',
    'level_hint': 'Nivel de alerta',
    'time_hint': 'Última actualización',
    'state_codes': {
      '1': {
        'severity': 'Desconocido',
        'description': 'Nivel de inundación desconocido, tenga precaución '
      },
      '2': {
        'severity': 'Menor',
        'description': 'Inundación entre 10 y 70 cm'
      },
      //TODO:Get Translations spanish
      '3': {
        'severity': 'Moderate',
      ...
      '4': {
        'severity': 'Sedang',
        'description': 'Inundación arriba de 150 cm'
      },
    }
  },
  'earthquake_info': {
  ...
  'report_content': {
    ...
    'whatsapp': {
      'title': 'Reporte via WhatsApp',
      'steps': [
        'Mandar mensaje a [numero] o [enlace de bot]',
        'AyudaBot le enviará un enlace único para enviar un reporte de desastre.',
        'Abra el enlace y siga las instrucciones para ingresar la ubicación del peligro, cargar una foto y una descripción.',
        'AyudaBot le enviará una respuesta con un enlace a su reporte',
        'Consulte mapeatudesastre.org en su navegador para obtener información actualizada sobre desastres.'
      ]
    },
    'twitter': {
    ...
    'web': {
      ...
      'steps': [
        ...
        'Haga clic en el botón Reportar desastre y siga las instrucciones para ingresar la ubicación del peligro, cargar una foto y una descripción.',
        'Consulte Mapeatudesastre.org en su navegador para obtener información actualizada sobre desastres.'
      ]
    }
  },
