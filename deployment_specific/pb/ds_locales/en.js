const en = {
  ...
  'search_ph': 'Search',
  'popup_text': 'Welcome to PetaBencana.id, a real time map of disasters in Indonesia! To load disaster data, select province:',
  'popup_footer': 'PetaBencana.id displays real time information of disasters. For historical data, please visit <a href="https://info.petabencana.id/" target="_blank">info.petabencana.id</a>.',
