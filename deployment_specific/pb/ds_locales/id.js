const id = {
  ...
  'search_ph': 'Cari',
  'popup_text': 'Selamat datang di PetaBencana.id, peta real-time laporan bencana di Indonesia! Untuk melihat laporan bencana terkini, pilih provinsi:',
  'popup_footer': 'PetaBencana.id menampilkan informasi bencana real-time. Kunjungi <a href="https://info.petabencana.id/" target="_blank">info.petabencana.id</a> untuk melihat data historis.',
